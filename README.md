...
* `apt update`
* `apt install git -y`
* `git clone git://github.com/Mohit309/hack.git` 
*' git clone git://github.com/Mohit309/hack'
* `cd nexphisher`
#### > SETUP : `bash setup`
...
#### > Run : `bash nexphisher`
    ## Single Command :
```
apt update ; apt install git -y ; git clone git://github.com/Mohit309/hack.git ; cd nexphisher ; bash setup ; bash nexphisher
```
<br>
<p align="center">
...
## Find Me on :
[![Github](https://img.shields.io/badge/Github-Mohit309-hack-green?style=for-the-badge&logo=github)](https://github.com/htr-tech)
